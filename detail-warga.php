      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-3 text-gray-800">Detail Warga</h1>
            ...
            ?>
                ...
                <div class="row">
                    <div class="col-md-8">
                    <table class="table table-striped table-bordered border-left-primary">
                        <tr>
                            <td><b>No ID</b></td>
                        ...
                        <tr>
                            <td><a href="index.php" class="btn btn-primary btn-icon-split"><span class="text"><b>Kembali</b></span></a></td>
                            <td></td>
                        </tr>
                    </table>    
                </div>
